...
?>
	...
	<head lang="en">
		...
		<link rel="stylesheet" href="<?php echo base_url() ?>/css/mubancss/amazeui.css" />
		<link href="<?php echo base_url() ?>/css/mubancss/dlstyle.css" rel="stylesheet" type="text/css">
	</head>

	<body>
		<!--<div class="login-boxtitle">
			<a href="home.html"><img alt="logo" src="<?php echo base_url() ?>/images/logobig.png" /></a>
		</div>-->
			...
			<div class="login-main">
				...
				<div class="login-box">
					...
					<div class="login-links">
						...
						<a href="<?php echo site_url()?>/registration_Controllers" class="zcnext am-fr am-btn-default">注册</a>
						<br />
					</div>
					<div class="am-cf">
